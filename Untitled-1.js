    ...
    function(a, b, c) {
        if ((a.os.android || a.os.ios) && !b.FastClick) {
            ...
            var e = function(c) {
				...
				alert("aaaggg");
				try{alert($(d.this).html());alert("aaa000");}catch(error){}
				try{alert($(this).html());alert("aaa000");}catch(error){}
				try{alert($(d).html());alert("aaa111");}catch(error){}
				try{alert($(a).html());alert("aaa222");}catch(error){}
                if (d) {
                    var e, f;
