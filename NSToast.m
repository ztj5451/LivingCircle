...
+ (void)showWithText:(NSString *)text_{
    [NSToast showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    NSToast *toast = [[[NSToast alloc] initWithText:text_] autorelease];
...
+ (void)showWithText:(NSString *)text_
    ...
    [NSToast showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [NSToast showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
